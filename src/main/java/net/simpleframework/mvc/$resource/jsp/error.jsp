...
<%@ page import="net.simpleframework.mvc.MVCConst"%>
<%
	final Throwable th = (Throwable) SessionCache
			.lget(MVCConst.SESSION_ATTRI_THROWABLE);
	if (th == null) {
%>
...
<%
	...
	SessionCache.lremove(MVCConst.SESSION_ATTRI_THROWABLE);
%>
<div align="center">
  <div class="simple_toolbar" style="width: 640px; margin-top: 100px; text-align: left;">
    <div style="height: 24px;">
      <div style="float: right;">
        <input type="button" value="#(error.1)" onclick="history.back();" /> <input 
          type="button" value="#(error.2)" onclick="$Actions.loc('/');" />
      </div>
    ...
    <div class="simple_toolbar wrap_text" style="margin: 6px 0px; color: #8D3212;"><%=HtmlUtils.convertHtmlLines(HtmlEncoder
					.text(MVCContext.get().getThrowableMessage(th)))%></div>
    <div class="simple_toolbar" style="padding: 4px;">
